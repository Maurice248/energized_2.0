...
export default function VerifyEmail({ name, verifyUrl }: Props) {
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm your email to activate your Energized account</Preview>
      <Body
        style={{
          backgroundColor: BG,
          margin: 0,
      ...
      >
        ...
        >
          ...
          <Section style={{ padding: "40px 32px 8px" }}>
            ...
            >
              Click the button below to activate your Energized account. The
              link is valid for the next hour.
            </Text>
          </Section>
          ...
          <Section style={{ padding: "20px 32px" }}>
            ...
            >
              If you didn&rsquo;t create an Energized account, you can safely
              ignore this email.
            </Text>
          </Section>
        </Container>
