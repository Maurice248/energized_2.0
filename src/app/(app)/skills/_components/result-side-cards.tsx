    ...
    <div className="grid gap-4">
      {passed && (
        <div className="rounded-3xl border border-slate-200 bg-white p-7">
          <h4 className="text-xl font-bold tracking-tight">Added to your profile</h4>
          <p className="mt-1.5 text-sm leading-relaxed text-slate-600">
            Recruiters filtering for {sectorName} can now find you first.
          </p>
          <div className="mt-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-5">
            ...
            <div className="mt-3.5 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3.5 py-2 text-sm font-medium">
              ...
              Verified <em className="not-italic font-bold italic text-[var(--brand-dark-blue)]">{sectorName}</em> · {score}/100
            </div>
          </div>
        </div>
      )}
