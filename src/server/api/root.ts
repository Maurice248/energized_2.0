...
import { jobseekerBillingRouter } from "@/server/api/routers/jobseeker-billing";
...
import { skillTestsRouter } from "@/server/api/routers/skill-tests";
...
export const appRouter = router({
  ...
  jobseekerBilling: jobseekerBillingRouter,
  jobs: jobsRouter,
